...
const MainPanel = kind({
	...
	render: () => (
		<div style={{ border: '2px solid', borderColor: 'blue', display: 'flex', flexDirection: 'column', backgroundColor: '#696969' }}>
			...
			<LectureFooter classroom_name='숭덕경상관 02112 (PC실습실)' temperature='24°' current_time='15:09' yyyy_mm_dd='2023/11/28' />
		</div>
	)
});
